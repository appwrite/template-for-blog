...
<div class="mb-16 mt-[54px] flex w-full max-w-[1200px] flex-col gap-8 px-4 xl:ms-[120px] xl:px-0">
	...
	<div class="flex h-auto flex-col items-start gap-8 rounded-2xl p-3 backdrop-blur-lg lg:flex-row">
		<div class="relative">
			<div
				class="absolute inset-0 h-[225px] rounded-xl bg-cover bg-center transition-opacity duration-500 md:w-auto lg:h-[396px]"
				style="background-image: url({featuredBlogPost.blurhash}); opacity: {loaded ? 0 : 1};"
			></div>

			<img
				bind:this={imgEl}
				class="h-[225px] w-full rounded-xl bg-gray-300 bg-cover object-cover md:w-auto lg:h-[396px]"
		...
		<div class="flex flex-1 flex-col gap-4 self-stretch md:p-6">
