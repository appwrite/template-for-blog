...
<footer
	class="flex flex-col justify-between gap-4 border-t bg-white p-4 text-sm dark:border-[#2C2C2F] dark:bg-[#1b1b1b] md:flex-row lg:p-[24px_40px]"
>
	<div class="flex items-center gap-3">
		...
		<div>
			...
			on
			<a href="https://github.com/appwrite/template-for-blog" target="_blank">GitHub</a>.
		</div>
	</div>
